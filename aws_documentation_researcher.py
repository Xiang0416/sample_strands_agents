    ...
    try:
        ...
        with documentation_mcp_server:
            ...
            research_agent = Agent(
                ...
                Finally, respond to the user's question using the information you've gathered.
                """,
                tools=tools,
...
if __name__ == "__main__":
    aws_documentation_researcher("List all the Amazon Nova model id and name of Amazon Bedrock")
